...
![The dockerfile of the 2d_slam_module repository](img/dockerfile.png)
...
![First part of the ball picking project compose file](img/compose_project.png)
